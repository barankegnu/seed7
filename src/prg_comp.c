...
/**
 *  Reinterpret the generic parameters as progType and call prgCpy.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function. This assures correct behaviour even
 *  if sizeof(genericType) != sizeof(progType).
 */
 ...
 *  if sizeof(genericType) != sizeof(progType).
 */
genericType prgCreateGeneric (const genericType from_value)
  ...
  /* prgCreateGeneric */
    ...
    result.value.ptrValue = (rtlPtrType)
        prgCreate((progType) ((const_rtlObjectType *) &from_value)->value.ptrValue);
 ...
 *  if sizeof(genericType) != sizeof(progType).
 */
void prgDestrGeneric (const genericType old_value)

  { /* prgDestrGeneric */
    prgDestr((progType) ((const_rtlObjectType *) &old_value)->value.ptrValue);
  } /* prgDestrGeneric */
